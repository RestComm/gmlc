...
{this-platform} {this-application} is an Open Source Java based GMLC Gateway Platform that routes ATI messages from the signaling network to service applications and the other way around.
