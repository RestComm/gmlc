...
The example HSQLDB DataSource is bound to the JNDI name java:/DefaultDS and its descriptor is available in the file [path]_restcomm-gmlc-version>/jboss-5.1.0.GA/server/default/deploy/hsqldb-ds.xml_.
...
You will also find a lot of examples in the folder [path]_restcomm-gmlc-version>/jboss-5.1.0.GA/docs/examples/jca/_. 
...
The {this-platform} jSS7 Stack User Guide in the [path]_restcomm-gmlc-<version>/docs/ss7/_ folder will assist you in configuring and managing the SS7 Stack.
